  ...
  <div class="flex flex-col">
    <div class="flex flex-col">
      <div :key="idx" v-for="(c, idx) of data" class="flex mx-auto flex-col">
        ...
        <div class="rounded-md shadow-inner  bg-gray-200 mt-3 mb-2 focus-within:bg-white focus-within:shadow-md w-full mx-auto">
          <input  v-model="input[idx]['letters']" class="bg-transparent  focus:outline-none px-3 text-lg w-full" />
        </div>
      </div>
    </div>
    <div>
